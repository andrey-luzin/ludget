  ...
  return (
    <div className="relative flex min-h-screen w-full bg-muted/30">
      ...
      <div className="flex min-h-screen flex-1 flex-col">
        {isMobile ? (
          <header className="sticky top-0 z-1 flex items-center border-b bg-background/95 px-4 py-1.5 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <Button
              variant="ghost"
              size="icon"
            ...
            <div className="text-base font-semibold">Ludget</div>
          </header>
        ) : null}
